...
$(function(){
        ...
        $("input[name=\"Submit\"]").click(function(){
                ...
                $.post("<?=\XHB2\URL($request->GetTranslate(), "Admin-ProductCategory-Add")?>", EncodeJson(param), function(data){
...
<div class="XHB-nav-home">
        <div class="container">
                ...
                <div class="split">/</div>
                <div class="item"><a href="javascript:void(0);"><?=\XHB2\Translate($request->GetTranslate(), "ProductCategoryAdd")?></a></div>
        </div>
</div>
        ...
        <div class="XHB-form">
                ...
                <div class="line">
                        <div class="item">
                                ...
                                <div class="XHB-input-panel">
                                        <input type="text" name="Title" class="XHB-input-text" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "PleaseEnterProductCategoryTitle")?>" />
                                </div>
                ...
                <div class="line">
                        <div class="item">
                                ...
                                <div class="XHB-input-panel">
                                        <input type="text" name="Keywords" class="XHB-input-text" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "PleaseEnterProductCategoryKeywords")?>" />
                                </div>
                ...
                <div class="line">
                        <div class="item">
                                ...
                                <div class="XHB-input-panel">
                                        <textarea id="textarea" name="Description" class="XHB-input-textarea" style="height: 60px; width:400px;" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "PleaseEnterProductCategoryDescription")?>"></textarea>
                                </div>
