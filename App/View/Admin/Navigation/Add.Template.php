...
$(function(){
        ...
        $("input[name=\"Submit\"]").click(function(){
                ...
                $.post("<?=\XHB2\URL($request->GetTranslate(), "Admin-Navigation-Add")?>", EncodeJson(param), function(data){
...
<div class="admin">
        <div class="XHB-form">
                <div class="title"><?=\XHB2\Translate($request->GetTranslate(), "NavigationAdd")?></div>
                <div class="line">
                        <div class="item">
                ...
                <div class="line">
                        <div class="item">
                                ...
                                <div class="XHB-input-panel">
                                        <input type="text" name="Title" class="XHB-input-text" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "PleaseEnterNavigationTitle")?>" />
                                </div>
                ...
                <div class="line">
                        <div class="item">
                                ...
                                <div class="XHB-input-panel">
                                        <input type="text" name="Link" class="XHB-input-text" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "PleaseEnterNavigationLink")?>" />
                                </div>
                ...
                <div class="line">
                        <div class="item">
                                ...
                                <div class="XHB-input-panel">
                                        <input type="text" name="Sort" class="XHB-input-text" style="width: 60px;" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "PleaseEnterNavigationSort")?>" />
                                </div>
