...
$(function(){
        ...
        $("input[name=\"Submit\"]").click(function(){
                ...
                $.post("<?=\XHB2\URL($request->GetTranslate(), "Admin-Navigation-Delete")?>", EncodeJson(param), function(data){
...
<div class="admin">
        <div class="XHB-form">
                <div class="title"><?=\XHB2\Translate($request->GetTranslate(), "NavigationDelete")?></div>
                <div class="line">
                        <div class="item">
                ...
                <div class="line">
                        <div class="item">
                                <div class="XHB-input-lable-right" style="width: 200px;"><?=\XHB2\Translate($request->GetTranslate(), "NavigationId")?></div>
                                <div class="XHB-input-panel">
                                        <?=$detail["Id"]?>
                                </div>
