...
$(function(){
        ...
        $("input[name=\"Submit\"]").click(function(){
                ...
                $.post("<?=\XHB2\URL($request->GetTranslate(), "Admin-Product-Edit")?>", EncodeJson(param), function(data){
...
<div class="XHB-nav-home">
        <div class="container">
                ...
                <div class="split">/</div>
                <div class="item"><a href="javascript:void(0);"><?=\XHB2\Translate($request->GetTranslate(), "ProductEdit")?></a></div>
        </div>
</div>
<div class="XHB-nav-tab">
        <div class="list">
                <div class="item active">
                        <a href="<?=\XHB2\URL($request->GetTranslate(), "Admin-Product-Edit")?>"><?=\XHB2\Translate($request->GetTranslate(), "ProductEdit")?></a>
                </div>
        </div>
        ...
        <div class="XHB-form">
                ...
                <div class="line">
                        <div class="item">
                                ...
                                <div class="XHB-input-panel">
                                        <input type="text" name="Title" class="XHB-input-text" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "PleaseEnterProductTitle")?>" value="<?=$detail["Title"]?>" />
                                </div>
