...
$(function(){
        ...
        $("input[name=\"Submit\"]").click(function(){
                ...
                $.post("<?=\XHB2\URL($request->GetTranslate(), "Admin-Product-Delete")?>", EncodeJson(param), function(data){
...
<div class="XHB-nav-home">
        <div class="container">
                ...
                <div class="split">/</div>
                <div class="item"><a href="javascript:void(0);"><?=\XHB2\Translate($request->GetTranslate(), "ProductDelete")?></a></div>
        </div>
</div>
<div class="XHB-nav-tab">
        <div class="list">
                <div class="item active">
                        <a href="<?=\XHB2\URL($request->GetTranslate(), "Admin-Product-Delete")?>"><?=\XHB2\Translate($request->GetTranslate(), "ProductDelete")?></a>
                </div>
        </div>
...
<div class="admin">
        <div class="XHB-form">
                <div class="title"><?=\XHB2\Translate($request->GetTranslate(), "ProductDelete")?></div>
                <div class="line">
                        <div class="item">
