...
$(function(){
        ...
        $("input[name=\"Submit\"]").click(function(){
                ...
                $.post("<?=\XHB2\URL($request->GetTranslate(), "Admin-SinglePage-Edit")?>", EncodeJson(param), function(data){
        ...
        <div class="XHB-form">
                ...
                <div class="line">
                        <div class="item">
                                ...
                                <div class="XHB-input-panel">
                                        <input type="text" name="Title" class="XHB-input-text" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "PleaseEnterSinglePageTitle")?>" value="<?=$detail["Title"]?>" />
                                </div>
                ...
                <div class="line">
                        <div class="item">
                                ...
                                <div class="XHB-input-panel">
                                        <textarea id="textarea" name="Description" class="XHB-input-textarea" style="height: 60px; width:400px;" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "PleaseEnterSinglePageDescription")?>"><?=$detail["Description"]?></textarea>
                                </div>
