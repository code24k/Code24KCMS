...
function InitSearch(){
        ...
        $("input[name=\"submit\"]").click(function(){
                var url = "<?=\XHB2\URL($request->GetTranslate(), "Admin-ArticleCategory-List")?>"
...
<div class="XHB-nav-home">
        <div class="container">
                ...
                <div class="split">/</div>
                <div class="item"><a href="javascript:void(0);"><?=\XHB2\Translate($request->GetTranslate(), "ArticleCategoryList")?></a></div>
        </div>
</div>
...
<div class="admin">
                ...
                <div class="data">
                        <div class="item">
                                ...
                                <div class="XHB-input-panel">
                                        <input name="Id" class="XHB-input-text" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "EnterArticleCategoryId")?>" value="<?=$request->GetParseUrlParam("Id")?>" />
                                </div>
                        </div>
                        <div class="item">
                                <div class="XHB-input-lable"><?=\XHB2\Translate($request->GetTranslate(), "ArticleCategoryTitle")?></div>
                                <div class="XHB-input-panel">
                                        <input name="Title" class="XHB-input-text" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "EnterArticleCategoryTitle")?>" value="<?=$request->GetParseUrlParam("Title")?>" />
                                </div>
                        </div>
                        <div class="item">
                                <div class="XHB-input-panel">
        ...
        <div class="XHB-table">
                <div class="title">
                     ...
                     <div class="item" style="width: 30%;"><?=\XHB2\Translate($request->GetTranslate(), "ArticleCategoryTitle")?></div>
                     <div class="item" style="width: 12%;"><?=\XHB2\Translate($request->GetTranslate(), "ArticleCategoryStatus")?></div>
                     <div class="item" style="width: 12%;"><?=\XHB2\Translate($request->GetTranslate(), "ArticleCategoryUpdateTime")?></div>
                ...
                <div class="data">
                        ...
                        <div class="right">
                                <a href="<?=\XHB2\URL($request->GetTranslate(), "Web-ArticleCategory-Detail-{$val["Id"]}")?>" target="_blank" class="XHB-button-green-a">
                                        <?=\XHB2\Translate($request->GetTranslate(), "View")?>
                                </a>
                                <a href="<?=\XHB2\URL($request->GetTranslate(), "Admin-ArticleCategory-Delete-{$val["Id"]}")?>" class="XHB-button-green-a">
                                        <?=\XHB2\Translate($request->GetTranslate(), "Delete")?>
                                </a>
                                <a href="<?=\XHB2\URL($request->GetTranslate(), "Admin-ArticleCategory-Edit-{$val["Id"]}")?>" class="XHB-button-green-a">
                ...
                <?php else:?>
                        <div class="empty">
                                ...
                                <a href="<?=\XHB2\URL($request->GetTranslate(), "Admin-ArticleCategory-Add")?>" class="XHB-button-green-a">
                                        <?=\XHB2\Translate($request->GetTranslate(), "ArticleCategoryAdd")?>
                                </a>
                        </div>
                <?php endif;?>
        </div>
