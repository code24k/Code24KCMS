...
$(function(){
        ...
        $("input[name=\"Submit\"]").click(function(){
                ...
                $.post("<?=\XHB2\URL($request->GetTranslate(), "Admin-Article-Delete")?>", EncodeJson(param), function(data){
...
<div class="XHB-nav-home">
        <div class="container">
                ...
                <div class="split">/</div>
                <div class="item"><a href="javascript:void(0);"><?=\XHB2\Translate($request->GetTranslate(), "ArticleDelete")?></a></div>
        </div>
</div>
<div class="XHB-nav-tab">
        <div class="list">
                <div class="item active">
                        <a href="<?=\XHB2\URL($request->GetTranslate(), "Admin-Article-Delete")?>"><?=\XHB2\Translate($request->GetTranslate(), "ArticleDelete")?></a>
                </div>
        </div>
...
<div class="admin">
        <div class="XHB-form">
                <div class="title"><?=\XHB2\Translate($request->GetTranslate(), "ArticleDelete")?></div>
                <div class="line">
                        <div class="item">
                ...
                <div class="line">
                        <div class="item">
                                <div class="XHB-input-lable-right" style="width: 200px;"><?=\XHB2\Translate($request->GetTranslate(), "ArticleId")?></div>
                                <div class="XHB-input-panel">
                                        <?=$detail["Id"]?>
                                </div>
