...
function InitSearch(){
        ...
        $("input[name=\"submit\"]").click(function(){
                var url = "<?=\XHB2\URL($request->GetTranslate(), "Admin-Article-List")?>"
...
<div class="XHB-nav-home">
        <div class="container">
                ...
                <div class="split">/</div>
                <div class="item"><a href="javascript:void(0);"><?=\XHB2\Translate($request->GetTranslate(), "ArticleList")?></a></div>
        </div>
</div>
<div class="XHB-nav-tab">
        <div class="list">
                <div class="item active">
                        <a href="<?=\XHB2\URL($request->GetTranslate(), "Admin-Article-List")?>"><?=\XHB2\Translate($request->GetTranslate(), "ArticleList")?></a>
                </div>
        </div>
...
<div class="admin">
                ...
                <div class="data">
                        <div class="item">
                                ...
                                <div class="XHB-input-panel">
                                        <input name="Id" class="XHB-input-text" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "EnterArticleId")?>" value="<?=$request->GetParseUrlParam("Id")?>" />
                                </div>
                        </div>
                        <div class="item">
                                <div class="XHB-input-lable"><?=\XHB2\Translate($request->GetTranslate(), "ArticleTitle")?></div>
                                <div class="XHB-input-panel">
                                        <input name="Title" class="XHB-input-text" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "EnterArticleTitle")?>" value="<?=$request->GetParseUrlParam("Title")?>" />
                                </div>
                        </div>
                        <div class="item">
                                <div class="XHB-input-panel">
        ...
        <div class="XHB-table">
                <div class="title">
                     ...
                     <div class="item" style="width: 30%;"><?=\XHB2\Translate($request->GetTranslate(), "ArticleTitle")?></div>
                     <div class="item" style="width: 12%;"><?=\XHB2\Translate($request->GetTranslate(), "ArticleStatus")?></div>
                     <div class="item" style="width: 12%;"><?=\XHB2\Translate($request->GetTranslate(), "ArticleUpdateTime")?></div>
                ...
                <div class="data">
                        ...
                        <div class="right">
                                <a href="<?=\XHB2\URL($request->GetTranslate(), "Web-Article-Detail-{$val["Id"]}")?>" target="_blank" class="XHB-button-green-a">
                                        <?=\XHB2\Translate($request->GetTranslate(), "View")?>
                                </a>
                                <a href="<?=\XHB2\URL($request->GetTranslate(), "Admin-Article-Delete-{$val["Id"]}")?>" class="XHB-button-green-a">
                                        <?=\XHB2\Translate($request->GetTranslate(), "Delete")?>
                                </a>
                                <a href="<?=\XHB2\URL($request->GetTranslate(), "Admin-Article-Edit-{$val["Id"]}")?>" class="XHB-button-green-a">
