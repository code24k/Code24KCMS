...
$(function(){
        ...
        $("input[name=\"Submit\"]").click(function(){
                ...
                $.post("<?=\XHB2\URL($request->GetTranslate(), "Admin-Article-Add")?>", EncodeJson(param), function(data){
...
<div class="XHB-nav-home">
        <div class="container">
                ...
                <div class="split">/</div>
                <div class="item"><a href="javascript:void(0);"><?=\XHB2\Translate($request->GetTranslate(), "ArticleAdd")?></a></div>
        </div>
</div>
<div class="XHB-nav-tab">
        <div class="list">
                <div class="item active">
                        <a href="<?=\XHB2\URL($request->GetTranslate(), "Admin-Article-Add")?>"><?=\XHB2\Translate($request->GetTranslate(), "ArticleAdd")?></a>
                </div>
        </div>
        ...
        <div class="XHB-form">
                ...
                <div class="line">
                        <div class="item">
                                ...
                                <div class="XHB-input-panel">
                                        <input type="text" name="Title" class="XHB-input-text" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "PleaseEnterArticleTitle")?>" />
                                </div>
                ...
                <div class="line">
                        <div class="item">
                                ...
                                <div class="XHB-input-panel">
                                        <input type="text" name="Keywords" class="XHB-input-text" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "PleaseEnterArticleKeywords")?>" />
                                </div>
                ...
                <div class="line">
                        <div class="item">
                                ...
                                <div class="XHB-input-panel">
                                        <textarea id="textarea" name="Description" class="XHB-input-textarea" style="height: 60px; width:400px;" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "PleaseEnterArticleDescription")?>"></textarea>
                                </div>
                ...
                <div class="line">
                        <div class="item">
                                ...
                                <div class="XHB-input-panel">
                                        <input type="text" name="CreateTime" class="XHB-input-text" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "PleaseEnterArticleCreateTime")?>" value="<?=date("Y-m-d")?>" />
                                </div>
                ...
                <div class="line">
                        <div class="item">
                                ...
                                <div class="XHB-input-panel">
                                        <input type="text" name="Visits" class="XHB-input-text" placeholder="<?=\XHB2\Translate($request->GetTranslate(), "PleaseEnterArticleVisits")?>" value="<?=rand(100, 1000)?>" />
                                </div>
